...
f = 2
HTL = 3
period = 5 -- cycle every 5 seconds
...
function main()
  ...
  local desync_wait = (period * math.random())
  ...
  -- start dissemination: array of function pointer to forward, anonymous anti-entropy function
  events.periodic(period, {forward, function()
    local success, res = rpc.acall(selectPartner(), {"selectToKeep", selectToSend()})
